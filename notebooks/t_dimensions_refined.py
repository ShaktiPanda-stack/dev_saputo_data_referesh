...
def main():
    ...
    try:
        ...
        # print(dimension_data_mapped.limit(10))
        app_env = "prod"
        # # Run validations
        ...
        # dimension_data_mapped.show(200, truncate=False)
        # print("\n=========================================================\n")

        # print("Pipeline completed successfully! (No DB write performed)")

        # # ---------------------- ROW & COLUMN COUNT ----------------------
        # row_count = dimension_data_mapped.count()
        # column_count = len(dimension_data_mapped.columns)

        # print(f"\nRows that would be inserted: {row_count}")
        # print(f"Columns that would be inserted: {column_count}")
        # print(f"Column names: {dimension_data_mapped.columns}\n")
