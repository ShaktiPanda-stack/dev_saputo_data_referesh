...
from utils.rfm_utils.calculate_rfm_score import rfm_analysis, cost_rfm_pipeline,cost_rfm_pipeline_good
...
def main():
    ...
    try:
        ...
        app_env="prod"
        connection_details = {}
        connection_details["jdbc_url"] = os.getenv("postgres_url")
        connection_details["user"] = os.getenv("postgres_user")
        connection_details["password"] = os.getenv("postgres_password")
        ...
        max_date_str = max_date_row[0]["max_date_str"] 
        rfm_results = cost_rfm_pipeline_good(
        ...
        # rfm_results_bu = rfm_results

        # # Map indicator columns
        # print("Incator Mapping")
        # indicator_mappings = {
        ...
        result = write_to_postgres(
            df=df_filled,
            table_name=f"ca_{app_env}.t_recency_frequency_good",
            mode="overwrite",
