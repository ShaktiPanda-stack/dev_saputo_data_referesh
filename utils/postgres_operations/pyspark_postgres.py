...
def read_from_postgres(table_name=None, query=None, spark=spark_postgres, connection_details=None):
    """
...
def write_to_postgres(df, table_name, mode="append", connection_details=None, spark=spark_postgres):
    """
